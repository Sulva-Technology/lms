...
export function CreditUnitSummary({ currentCredits, minCredits, maxCredits }: Props) {
  ...
  let statusText = "bg-blue-500/10 text-blue-400 border-blue-500/20";
  ...
  return (
    <div className="glass-panel p-5 rounded-[24px] sticky top-24 z-10">
      <div className="flex items-center justify-between mb-4">
        <h3 className="font-outfit font-semibold text-lg flex items-center gap-2 text-white">
      ...
      <div className="relative h-3 w-full bg-slate-800 rounded-full overflow-hidden mb-2">
        <motion.div 
          initial={{ width: 0 }}
