      ...
      <div className="max-w-4xl mx-auto space-y-16 pb-20">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-4 mt-6">
            ...
            <Link href="/docs/glassmorphism-system" className="border border-line bg-surface px-4 py-2 rounded-full text-sm font-medium text-ink hover:text-ink flex items-center gap-2 border border-line"><Sparkles size={16} className="text-success" /> GLASSMORPHISM_SYSTEM.md</Link>
            ...
            <Link href="/docs/course-learning-design" className="border border-line bg-surface px-4 py-2 rounded-full text-sm font-medium text-ink hover:text-ink flex items-center gap-2 border border-line"><Sparkles size={16} className="text-danger" /> COURSE_LEARNING_DESIGN.md</Link>
