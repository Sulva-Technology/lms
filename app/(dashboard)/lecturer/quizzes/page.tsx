...
export default async function LecturerQuizzesPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8 pb-20">
      <div className="flex flex-col gap-5 rounded-[32px] border border-line bg-surface p-6 shadow-2xl backdrop-blur-2xl md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <h1 className="font-outfit text-3xl font-semibold tracking-tight text-ink">Quiz Studio</h1>
          <p className="mt-2 max-w-2xl text-ink-muted">
            Build, publish, and review assessments for your assigned course sections.
          </p>
        </div>
        <div className="rounded-2xl border border-line bg-status-soft px-4 py-3 text-sm text-ink-muted">
